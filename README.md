...
**<span style="font-size:20px;">Près des trois quarts des accidents de la route impliquent des voitures en condition météorologique dite normale</span>** \
...
**<span style="font-size:20px;">Une répartition irrégulière des usagers de la route en fonction des conditions météorologiques</span>** \
...
**<span style="font-size:20px;">La saisonnalité représentative de la météorologie : des usagers plus attentifs lors d’une météo capricieuse ?</span>** \
...
**<span style="font-size:20px;">Gravité de l’accidentologie : en cas de brouillard, 13% des accidents sont mortels</span>** \
...
**<span style="font-size:20px;">Mortalité sur les routes : les cyclomotoristes plus impactés par temps de vent fort</span>** \
